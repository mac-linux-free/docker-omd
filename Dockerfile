...
RUN apt-get update && \
    ...
    wget --no-check-certificate https://mathias-kettner.de/support/1.4.0p24/check-mk-raw-1.4.0p24_0.stretch_amd64.deb && \
    (dpkg -i check-mk-raw-1.4.0p24_0.stretch_amd64.deb || true) && \
